 ...
 * BrandImage
 *
 * @link https://developers.lightspeedhq.com/ecom/endpoints/brandimage
 */
class BrandImage extends Resource
{
     ...
     * @var string
     */
    protected string $endpoint = '/brands/{id}/images';
     ...
     * @var string
     */
    protected string $lightspeedResource = 'brandImage';
