 ...
 * CategoryImage
 *
 * @link https://developers.lightspeedhq.com/ecom/endpoints/categoryimage
 */
class CategoryImage extends Resource
{
     ...
     * @var string
     */
    protected string $endpoint = '/categories/{id}/images';
     ...
     * @var string
     */
    protected string $lightspeedResource = 'categoryImage';
